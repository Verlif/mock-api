package idea.verlif.mockapi.mock.pool;
...
public class YamlDataPool extends FieldDataPool {
    ...
    public void initData() throws Exception {
        mockDataCreator.dataPool(this);
        mockDataCreator.getConfig().dataPool(this);
        if (pool != null) {
    ...
    public Object[] getValues(ClassGrc classGrc, String key) {
        ...
        if (classGrc instanceof FieldGrc) {
            ...
            if (fieldDataPool != null) {
                // 当存在对应名称的属性池时返回值
                Object[] values = fieldDataPool.getValues(classGrc, key);
                if (values != null) {
                    return values;
                }
            }
